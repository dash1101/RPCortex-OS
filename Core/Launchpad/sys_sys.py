...
def help(args=None):
    ...
    if a == 'osmgmt':
        ...
        multi("    'task background on' fire tasks while you're idle at the prompt")
        multi("  asyncmode on|off     Toggle the async (multitasking) shell; 'off' reverts to sync")
        multi("  service add <cmd>    Background service, e.g. httpd start --bg (runs while you work)")
